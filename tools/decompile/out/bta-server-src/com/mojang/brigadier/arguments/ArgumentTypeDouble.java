...
public class ArgumentTypeDouble implements ArgumentType<Double> {
   ...
   private ArgumentTypeDouble(double minimum, double maximum) {
   ...
   public static ArgumentTypeDouble doubleArg(double min) {
      return doubleArg(min, Double.MAX_VALUE);
   }

   public static ArgumentTypeDouble doubleArg(double min, double max) {
   ...
   public boolean equals(Object o) {
      if (this == o) {
         return true;
      } else if (!(o instanceof ArgumentTypeDouble)) {
         return false;
      } else {
         ArgumentTypeDouble that = (ArgumentTypeDouble)o;
