...
public class BlockLogicCropsWheat extends BlockLogicFlower implements IBonemealable {
   ...
   public ItemStack[] getBreakResult(World world, EnumDropCause dropCause, int meta, TileEntity tileEntity) {
      return meta != 7
         ? new ItemStack[]{new ItemStack(Items.SEEDS_WHEAT)}
         : new ItemStack[]{new ItemStack(Items.SEEDS_WHEAT, world.rand.nextInt(3) + 1), new ItemStack(Items.WHEAT)};
   }
