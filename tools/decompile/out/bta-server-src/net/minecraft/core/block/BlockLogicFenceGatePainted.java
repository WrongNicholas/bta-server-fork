...
public class BlockLogicFenceGatePainted extends BlockLogicFenceGate implements IPainted {
   public static final int MASK_COLOR = 240;

   public BlockLogicFenceGatePainted(Block<?> block) {
      super(block);
   }
   ...
   public void removeDye(World world, int x, int y, int z) {
      ...
      world.setBlockAndMetadataWithNotify(x, y, z, Blocks.FENCE_GATE_PLANKS_OAK.id(), meta & -241);
   }
