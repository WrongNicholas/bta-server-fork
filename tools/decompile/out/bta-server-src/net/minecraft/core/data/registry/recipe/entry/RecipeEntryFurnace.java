...
import net.minecraft.core.data.registry.recipe.adapter.RecipeFurnaceJsonAdapter;
import net.minecraft.core.data.registry.recipe.adapter.RecipeJsonAdapter;
import net.minecraft.core.item.ItemStack;

public class RecipeEntryFurnace extends RecipeEntryBase<RecipeSymbol, ItemStack, Void> implements HasJsonAdapter {
   public RecipeEntryFurnace(RecipeSymbol input, ItemStack output) {
      super(input, output, null);
   }

   public RecipeEntryFurnace() {
   }
   ...
   public RecipeJsonAdapter<?> getAdapter() {
      return new RecipeFurnaceJsonAdapter();
   }
}
