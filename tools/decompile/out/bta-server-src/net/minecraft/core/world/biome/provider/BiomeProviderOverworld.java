...
public final class BiomeProviderOverworld extends BiomeProvider {
   ...
   public BiomeProviderOverworld withTemperatureScales(double xScale, double zScale, double exponent, double fuzzPercentage) {
   ...
   public BiomeProviderOverworld withHumidityScales(double xScale, double zScale, double exponent, double fuzzPercentage) {
   ...
   public BiomeProviderOverworld withFuzzinessScales(double xScale, double zScale, double exponent) {
