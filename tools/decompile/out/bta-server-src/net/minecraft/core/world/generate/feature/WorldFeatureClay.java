...
public class WorldFeatureClay extends WorldFeature {
   private int clayBlockId = Blocks.BLOCK_CLAY.id();
   private int numberOfBlocks;
   private int generateInId;

   public WorldFeatureClay(int numberOfBlocks) {
      this(numberOfBlocks, Blocks.SAND);
   }

   @MethodParametersAnnotation(names = {"numberOfBlocks", "block"})
   public WorldFeatureClay(int numberOfBlocks, Block<?> block) {
