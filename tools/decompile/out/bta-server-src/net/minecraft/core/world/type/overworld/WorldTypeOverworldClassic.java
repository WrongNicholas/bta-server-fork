...
public class WorldTypeOverworldClassic extends WorldTypeOverworld {
   public WorldTypeOverworldClassic(WorldType.Properties properties) {
      super(properties);
   }
   ...
   public ChunkGenerator createChunkGenerator(World world) {
      return new ChunkGeneratorClassic(world);
   }
}
