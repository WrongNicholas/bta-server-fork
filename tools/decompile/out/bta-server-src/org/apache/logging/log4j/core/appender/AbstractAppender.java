...
public abstract class AbstractAppender extends AbstractFilterable implements Appender, LocationAware {
   ...
   protected AbstractAppender(
      final String name, final Filter filter, final Layout<? extends Serializable> layout, final boolean ignoreExceptions, final Property[] properties
   ) {
   ...
   public abstract static class Builder<B extends AbstractAppender.Builder<B>> extends AbstractFilterable.Builder<B> {
      ...
      public Layout<? extends Serializable> getOrCreateLayout() {
         return (Layout<? extends Serializable>)(this.layout == null ? PatternLayout.createDefaultLayout(this.configuration) : this.layout);
      }

      public Layout<? extends Serializable> getOrCreateLayout(final Charset charset) {
         return (Layout<? extends Serializable>)(this.layout == null
            ? PatternLayout.newBuilder().withCharset(charset).withConfiguration(this.configuration).build()
            : this.layout);
      }
