...
public final class SmtpAppender extends AbstractAppender {
   ...
   public static SmtpAppender createAppender(
      ...
      if (name == null) {
         ...
         return newBuilder()
            ...
            .setLayout(layout)
            .setFilter(filter)
            .setConfiguration((Configuration)(config != null ? config : new DefaultConfiguration()))
            .build();
      }
   }
   ...
   public static class Builder extends AbstractAppender.Builder<SmtpAppender.Builder> implements org.apache.logging.log4j.core.util.Builder<SmtpAppender> {
      ...
      public SmtpAppender.Builder setTo(final String to) {
         this.to = to;
         return this;
      }

      public SmtpAppender.Builder setCc(final String cc) {
         this.cc = cc;
         return this;
      }

      public SmtpAppender.Builder setBcc(final String bcc) {
         this.bcc = bcc;
         return this;
      }

      public SmtpAppender.Builder setFrom(final String from) {
         this.from = from;
         return this;
      }

      public SmtpAppender.Builder setReplyTo(final String replyTo) {
         this.replyTo = replyTo;
         return this;
      }

      public SmtpAppender.Builder setSubject(final String subject) {
         this.subject = subject;
         return this;
      }

      public SmtpAppender.Builder setSmtpProtocol(final String smtpProtocol) {
         this.smtpProtocol = smtpProtocol;
         return this;
      }

      public SmtpAppender.Builder setSmtpHost(final String smtpHost) {
         this.smtpHost = smtpHost;
         return this;
      }

      public SmtpAppender.Builder setSmtpPort(final int smtpPort) {
         this.smtpPort = smtpPort;
         return this;
      }

      public SmtpAppender.Builder setSmtpUsername(final String smtpUsername) {
         this.smtpUsername = smtpUsername;
         return this;
      }

      public SmtpAppender.Builder setSmtpPassword(final String smtpPassword) {
         this.smtpPassword = smtpPassword;
         return this;
      }

      public SmtpAppender.Builder setSmtpDebug(final boolean smtpDebug) {
         this.smtpDebug = smtpDebug;
         return this;
      }

      public SmtpAppender.Builder setBufferSize(final int bufferSize) {
         this.bufferSize = bufferSize;
         return this;
      }

      public SmtpAppender.Builder setSslConfiguration(final SslConfiguration sslConfiguration) {
         this.sslConfiguration = sslConfiguration;
         return this;
      }

      public SmtpAppender.Builder setLayout(final Layout<? extends Serializable> layout) {
         return (SmtpAppender.Builder)super.setLayout(layout);
      }

      public SmtpAppender.Builder setFilter(final Filter filter) {
      ...
      public SmtpAppender build() {
         ...
         MailManagerFactory factory = ServiceLoaderUtil.loadServices(MailManagerFactory.class, MethodHandles.lookup())
            .findAny()
