...
public class JeroMqManager extends AbstractManager {
   ...
   private JeroMqManager(final String name, final JeroMqManager.JeroMqConfiguration config) {
      super(null, name);
   ...
   public static JeroMqManager getJeroMqManager(
      ...
      return getManager(
         name,
         FACTORY,
         new JeroMqManager.JeroMqConfiguration(
            affinity,
            backlog,
   ...
   private static class JeroMqConfiguration {
      ...
      public String toString() {
         return "JeroMqConfiguration{affinity="
            ...
            + this.backlog
            + ", delayAttachOnConnect="
            + this.delayAttachOnConnect
            + ", identity="
            + Arrays.toString(this.identity)
            + ", ipv4Only="
            + this.ipv4Only
            + ", linger="
            + this.linger
   ...
   private static class JeroMqManagerFactory implements ManagerFactory<JeroMqManager, JeroMqManager.JeroMqConfiguration> {
      ...
      public JeroMqManager createManager(final String name, final JeroMqManager.JeroMqConfiguration data) {
