   ...
   public static class Builder<B extends NoSqlAppender.Builder<B>>
      ...
      public NoSqlAppender build() {
         ...
         if (this.provider == null) {
            ...
            NoSqlDatabaseManager<?> manager = NoSqlDatabaseManager.getNoSqlDatabaseManager(
               managerName, this.bufferSize, this.provider, this.additionalFields, this.getConfiguration()
            );
            return manager == null
               ? null
