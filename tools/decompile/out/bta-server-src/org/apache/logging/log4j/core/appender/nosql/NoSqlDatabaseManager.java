...
public final class NoSqlDatabaseManager<W> extends AbstractDatabaseManager {
   ...
   public static NoSqlDatabaseManager<?> getNoSqlDatabaseManager(final String name, final int bufferSize, final NoSqlProvider<?> provider) {
      return AbstractDatabaseManager.getManager(name, new NoSqlDatabaseManager.FactoryData(null, bufferSize, provider, null), FACTORY);
   }

   public static NoSqlDatabaseManager<?> getNoSqlDatabaseManager(
      final String name, final int bufferSize, final NoSqlProvider<?> provider, final KeyValuePair[] additionalFields, final Configuration configuration
   ) {
      return AbstractDatabaseManager.getManager(name, new NoSqlDatabaseManager.FactoryData(configuration, bufferSize, provider, additionalFields), FACTORY);
   }
   ...
   private void setAdditionalFields(final NoSqlObject<W> entity) {
      if (this.additionalFields != null) {
         NoSqlObject<W> object = (NoSqlObject<W>)this.connection.createObject();
