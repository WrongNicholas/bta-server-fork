...
public class StrSubstitutor implements ConfigurationAware {
   ...
   public StrSubstitutor(final Map<String, String> valueMap) {
      this(new PropertiesLookup(valueMap), DEFAULT_PREFIX, DEFAULT_SUFFIX, '$');
   }
   ...
   public String replace(final LogEvent event, final String source) {
      if (source == null) {
         ...
         try {
            ...
            return handleFailedReplacement(source, var5);
         }
   ...
   public String replace(final LogEvent event, final String source, final int offset, final int length) {
      if (source == null) {
         ...
         try {
            ...
            return handleFailedReplacement(source, var7);
         }
   ...
   public String replace(final LogEvent event, final char[] source) {
      if (source == null) {
         ...
         try {
            ...
            return handleFailedReplacement(new String(source), var5);
         }
   ...
   public String replace(final LogEvent event, final char[] source, final int offset, final int length) {
      if (source == null) {
         ...
         try {
            ...
            return handleFailedReplacement(new String(source, offset, length), var7);
         }
   ...
   public String replace(final LogEvent event, final StringBuffer source) {
      if (source == null) {
         ...
         try {
            ...
            return handleFailedReplacement(source.toString(), var5);
         }
   ...
   public String replace(final LogEvent event, final StringBuffer source, final int offset, final int length) {
      if (source == null) {
         ...
         try {
            ...
            return handleFailedReplacement(source.substring(offset, offset + length), var7);
         }
   ...
   public String replace(final LogEvent event, final Object source) {
      if (source == null) {
         ...
         try {
            ...
            return handleFailedReplacement(stringValue, var6);
         }
   ...
   public boolean replaceIn(final LogEvent event, final StringBuffer source, final int offset, final int length) {
      if (source == null) {
         ...
         try {
            ...
            StatusLogger.getLogger().error("Replacement failed on {}", source, var7);
            return false;
         }
                     ...
                     if (nestedVarCount == 0) {
                        ...
                        if (valueDelimiterMatcher != null) {
                           ...
                           for (int i = 0;
                              i < varNameExprChars.length
                                 && (substitutionInVariablesEnabled || prefixMatcher.isMatch(varNameExprChars, i, i, varNameExprChars.length) == 0);
                              i++
                           ) {
                        ...
                        if (varValue != null) {
                           ...
                           int change = resolvedResult != null && resolvedResult.isLookupEvaluationAllowedInValue()
                              ? this.substitute(event, buf, startPos, varLen, priorVariables)
                              : 0;
   ...
   protected LookupResult resolveVariable(final LogEvent event, final String variableName, final StringBuilder buf, final int startPos, final int endPos) {
      ...
      if (resolver == null) {
         ...
         try {
            ...
            StatusLogger.getLogger().error("Resolver failed to lookup {}", variableName, var8);
            return null;
         }
      }
   }
