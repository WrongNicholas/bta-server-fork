...
public enum AnsiEscape {
   ...
   public static Map<String, String> createMap(final String[] values, final String[] dontEscapeKeys) {
      String[] sortedIgnoreKeys = dontEscapeKeys != null ? (String[])dontEscapeKeys.clone() : Strings.EMPTY_ARRAY;
      Arrays.sort((Object[])sortedIgnoreKeys);
      ...
      if (names == null) {
         ...
         for (String name : names) {
            try {
               ...
               StatusLogger.getLogger().warn("The style attribute {} is incorrect.", name, var10);
            }
         }
