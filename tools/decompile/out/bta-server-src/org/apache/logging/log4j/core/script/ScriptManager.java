      ...
      if (logger.isDebugEnabled()) {
         ...
         for (ScriptEngineFactory factory : factories) {
            ...
            for (String name : languageNames) {
               if (this.allowedLanguages.contains(name.toLowerCase(Locale.ROOT))) {
                  if (names.length() > 0) {
                     names.append(", ");
                  }
         ...
         for (ScriptEngineFactory factory : factories) {
            for (String namex : factory.getNames()) {
               if (this.allowedLanguages.contains(namex.toLowerCase(Locale.ROOT))) {
                  if (names.length() > 0) {
                     names.append(", ");
                  }
